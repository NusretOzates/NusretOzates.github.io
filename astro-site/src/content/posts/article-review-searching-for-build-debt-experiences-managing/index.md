...
image: "img_0.jpg"
mediumUrl: "https://medium.com/dev-genius/article-review-searching-for-build-debt-experiences-managing-technical-debt-at-google-7851014563ab"
---
...
Lastly, we need to find and eliminate under-utilized dependencies but we cannot do that automatically, because generally, the solution is dividing the target library into smaller libraries. To handle that, the authors created a tool called Clipper.
...
> *Lesson learned: any change will always be opposed by someone and in a large organization it is important to have an independent group that is empowered to make decisions based on a global cost-benefit analysis.*
