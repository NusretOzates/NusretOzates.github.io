...
I'm working with GNNs for my MSc thesis, and using PyTorch Geometric (PyG) since it is one of the most popular libraries for GNNs.
It is very easy to use, but I wanted to understand how message passing works under the hood to customize it for my experiments.
As I learned it, I decided to write this blog post to share my knowledge with others who might be interested in the same topic.
