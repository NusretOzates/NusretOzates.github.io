...
In [part 2](https://medium.com/@m.nusret.ozates/tuning-and-deploying-hf-transformers-with-vertex-ai-part-2-training-code-591186445a2a), we created model training and tuning code and wrap it into a docker container.
